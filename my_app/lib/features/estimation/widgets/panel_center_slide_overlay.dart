...
class _PanelCenterSlidePainter extends CustomPainter {
  ...
  const _PanelCenterSlidePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double x25 = innerRect.left + (innerRect.width * 0.25);
    final double x50 = innerRect.left + (innerRect.width * 0.50);
    final double x75 = innerRect.left + (innerRect.width * 0.75);
    ...
    final List<_LineSpec> lines = <_LineSpec>[
      ...
      _LineSpec(
        id: 'divider_50',
        from: Offset(x50, innerRect.top),
        to: Offset(x50, innerRect.bottom),
      ),
      _LineSpec(
        id: 'divider_75',
    ...
    final Set<String> highlightLineIds = <String>{
      ...
      if (highlightM23) ...<String>{'inner_left', 'divider_50', 'inner_right'},
    ...
    final Set<String> highlightLabelIds = <String>{
      ...
      if (highlightDc30F &&
          ...
          c != 12 &&
          c != 14) ...<String>{'WT'},
      if (highlightDc30C && c == 2) ...<String>{'WT', 'HL', 'HR'},
    ...
    final List<Rect> panels = <Rect>[
      ...
      Rect.fromLTRB(x25, innerRect.top, x50, innerRect.bottom),
      Rect.fromLTRB(x50, innerRect.top, x75, innerRect.bottom),
  ...
  @override
  bool shouldRepaint(covariant _PanelCenterSlidePainter oldDelegate) {
...
class PanelCenterSlideOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      painter: _PanelCenterSlidePainter(
