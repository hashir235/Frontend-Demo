...
class _SlidingMSectionPainter extends CustomPainter {
  final String? selectedSection;
  final Map<String, String> sectionAliases;
  final int? collarId;
  final List<_ZoneSpec> zones;

  const _SlidingMSectionPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final bool highlightM30F = effectiveSection == 'M30F';
    final bool highlightM30 = effectiveSection == 'M30';
    final bool highlightM26 =
        effectiveSection == 'M26' || effectiveSection == 'M26F';
    ...
    // D29 is intentionally disabled for M_Section.
    final bool highlightD29 = effectiveSection == '__disabled_d29__';
    ...
    final Set<String> highlightLabels = {
      ...
      if (highlightM30F && collarId == 1) ...{'HR'},
      if (highlightM30F && collarId == 3) ...{'HR'},
      if (highlightM30F && collarId == 5) ...{'HR'},
      if (highlightM30F && collarId == 9) ...{'HR'},
      if (highlightM30F && collarId == 8) ...{'WT', 'HL'},
      if (highlightM30F && collarId == 10) ...{'WT'},
      if (highlightM30F && collarId == 11) ...{'WT'},
      if (highlightM30F && collarId == 1) ...{'WT'},
      if (highlightM30F && collarId == 5) ...{'WT'},
      if (highlightM30F && collarId == 6) ...{'WT'},
      if (highlightM30F &&
          collarId != 1 &&
          collarId != 3 &&
          collarId != 5 &&
      ...
      if (highlightM30 && collarId == 2) ...{'HR'},
      if (highlightM30 && collarId == 7) ...{'WT', 'HL'},
      if (highlightM30 && collarId == 8) ...{'HR'},
      if (highlightM30 && collarId == 9) ...{'WT'},
      if (highlightM30 && collarId == 12) ...{'WT', 'HL'},
      if (highlightM30 &&
          collarId != 4 &&
          collarId != 6 &&
          collarId != 7 &&
      ...
      if (highlightM30 && collarId == 4) ...{'HR'},
      if (highlightM30 && collarId == 6) ...{'HL'},
      if (highlightM30 && collarId == 11) ...{'HL', 'HR'},
      if (highlightM30 && collarId == 10) ...{'HL', 'HR'},
      if (highlightM30 && collarId == 13) ...{'HL', 'HR'},
      if (highlightM30 && collarId == 14) ...{'WT', 'HR'},
      if (highlightM26 &&
          collarId != 8 &&
          collarId != 9 &&
          collarId != 11 &&
      ...
      if (highlightM26 && (collarId == 8 || collarId == 9)) ...{'WB'},
      if (highlightM26 && collarId == 11) ...{'WB'},
      if (highlightM26 && collarId == 12) ...{'WB'},
      if (highlightM26 && collarId == 13) ...{'WB'},
      if (highlightM24) ...{'W'},
  ...
  @override
  bool shouldRepaint(covariant _SlidingMSectionPainter oldDelegate) {
...
class SlidingMSectionOverlay extends StatelessWidget {
  ...
  List<_ZoneSpec> _zones() {
    ...
    const universalSections = [m23, m24, m28];
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      painter: _SlidingMSectionPainter(
